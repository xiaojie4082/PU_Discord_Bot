...
async def help(
    ...
    view = discord.ui.View()
    button = discord.ui.Button(label=":thumbsup: 已解決", style=discord.ButtonStyle.green)
    view.add_item(button)
    button = discord.ui.Button(label=":thumbsdown: 未解決", style=discord.ButtonStyle.green)
    view.add_item(button)
